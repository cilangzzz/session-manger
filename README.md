...
![应用界面](screenshots/app_screenshots.png)

## 💡 使用案例

### 案例 1：多账号社交媒体管理

**场景**：运营人员需要同时管理多个社交媒体账号

![使用案例 1](screenshots/app_usage_01.png)

**步骤**：
1. 创建「工作账号」会话，登录公司官方账号
2. 创建「个人账号」会话，登录个人账号
3. 创建「测试账号」会话，用于测试新功能
4. 不同会话使用不同颜色标签组区分
5. 切换会话时自动切换 Cookies，无需重复登录
...
![使用案例 2](screenshots/app_usage_02.png)

**场景**：开发人员需要在不同环境间切换测试

**步骤**：
1. 创建「开发环境」会话，连接本地开发服务器
2. 创建「测试环境」会话，连接测试服务器
3. 创建「生产环境」会话，查看生产环境状态
4. 各环境独立登录状态，Cookie 不互相干扰

**优势**：
- ✅ 同一应用可同时查看多个环境状态
- ✅ 支持本地 IP 地址（如 `127.0.0.1`、`localhost`）
- ✅ 快捷键快速切换环境
